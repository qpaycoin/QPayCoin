...
const QString BITCOIN_IPC_PREFIX("QPayCoin:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click QPayCoin: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start QPayCoin: click-to-pay handler");
    else
...
{
    // clicking on QPayCoin: URLs creates FileOpen events on the Mac:
