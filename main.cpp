...
// Copyright (c) 2013 The QPayCoin developers
...
uint256 hashGenesisBlock("0x0000095af3910afca63c7bb31e9750902284309def5afdf6164577894f07b253");
static const unsigned int timeGenesisBlock = 1462524673;
...
const string strMessageMagic = "QPayCoin Signed Message:\n";
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
       const char* pszTimestamp = "already in already databases we QPaycoinpark from USA with Transactions.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.print();
        assert(block.hashMerkleRoot == uint256("0xd77d20c12fe3761006b9e9e409e3dfa6c0cc8d2da67722b68ccc33eeb8f8caf5"));
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("QPayCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("QPayCoinMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("QPayCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("QPayCoin-miner");
    ...
    try { loop {
        ...
        printf("Running QPayCoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("QPayCoinMiner terminated\n");
        throw;
    }
}
